...
2. Do it serde-style
3. Convert the HashMap to an "Object", the JSON name for a dictionary. (Presumably Vectors are called "Array" - I didn't check)
4. Simply use the `.insert` method as per usual.

## Example

```{.rs}
    let mut bp: serde_json::Map<String, serde_json::Value> = serde_json::Map::new();
    // I'm truncating to avoid using floats (ew)
    bp.insert(String::from("K"), serde_json::Value::Number(serde_json::Number::from(27)));
    bp.insert(String::from("C"), serde_json::Value::Number(serde_json::Number::from(-246)));
    bp.insert(String::from("F"), serde_json::Value::Number(serde_json::Number::from(-410)));

    ne.insert(String::from("boiling_point"), serde_json::Value::Object(bp));
```
...
- Can't say why I detest `use`, but I didn't use (ha) it.
...
fn main() {
    ...
    ne.insert(String::from("symbol"), Value::String(String::from("Ne")));
    ne.insert(String::from("phase_stp"), Value::String(String::from("gas")));

    ne.insert(String::from("group"), Value::Number(Number::from(18)));
    ne.insert(String::from("period"), Value::Number(Number::from(2)));
...
fn main() {
    ...
    ne.insert(String::from("symbol"), v_string!("Ne"));
    ne.insert(String::from("group"), v_number!(18));
```
